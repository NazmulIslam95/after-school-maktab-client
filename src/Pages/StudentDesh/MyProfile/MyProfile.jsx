            ...
            <div className="lg:col-span-1">
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <button className="mt-6 w-full bg-[#082f72] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#0a3a8a] transition-all duration-200">
                    Edit Profile
                  </button>
                </div>
              </motion.div>
                ...
                <div className="p-4">
                  <div className="flex items-center justify-center py-4">
                    <div className="text-center">
                      <div className="w-16 h-16 text-2xl mx-auto mb-2 rounded-full bg-blue-50 flex items-center justify-center text-[#082f72]">
                        <MdOutlineWatchLater />
                      </div>
